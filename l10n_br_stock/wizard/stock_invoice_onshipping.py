...
class stock_invoice_onshipping(osv.osv_memory):
    ...
    def _get_journal_id(self, cr, uid, context=None):
        ...
        for type in pick_types:
            search_tuple = ('cash', 'bank', 'general', 'situation')
            if type == 'out':
                search_tuple = ('sale', 'purchase_refund')
            elif type == 'in':
                search_tuple = ('purchase', 'sale_refund')

            value = acct_obj.search(cr, uid, [('type', 'in', search_tuple)])
