...
class account_tax_template(osv.osv):
    ...
    def onchange_tax_code_id(self, cr, uid, ids, tax_code_id, context=None):
        ...
        if obj_tax_code:
            ...
            result['value']['tax_include'] = obj_tax_code.tax_include
...
class wizard_multi_charts_accounts(osv.osv_memory):
    ...
    def execute(self, cr, uid, ids, context=None):
        ...
        for tax_code_template in self.pool.get('account.tax.code.template').browse(cr, uid, children_tax_code_template, context=context):
            ...
            if tax_code_id:
                obj_tax_code.write(cr, uid, tax_code_id, {'domain': tax_code_template.domain,'tax_discount': tax_code_template.tax_discount,'tax_include': tax_code_template.tax_include})
        ...
        for tax in self.pool.get('account.tax').browse(cr, uid, tax_ids, context=context):
            if tax.tax_code_id:
                obj_acc_tax.write(cr, uid, tax.id, {'domain': tax.tax_code_id.domain,'tax_discount': tax.tax_code_id.tax_discount,'tax_include': tax.tax_code_id.tax_include})
